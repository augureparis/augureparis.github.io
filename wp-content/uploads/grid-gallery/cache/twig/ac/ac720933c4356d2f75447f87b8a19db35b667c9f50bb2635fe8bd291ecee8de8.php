...
/* @galleries/sort.twig */
class __TwigTemplate_563899681397a2d2cb1588d160accac8a86e343a6c29029c9ad67f31f5c65323 extends Twig_SupTwg_Template
{
    ...
    public function block_header($context, array $blocks = array())
    {
        ...
        echo "\">";
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Sort Images")), "html", null, true);
        echo "</a>
    </nav>
...
\t\t                    <i class=\"fa fa-fw fa-arrow-left\"></i>";
        // line 30
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Back to Images List")), "html", null, true);
        echo "
\t\t                </a>
\t\t            </li>
\t\t        </ul>
...
\t\t\t\t\t\t<i class=\"fa fa-fw fa-save\"></i>";
        // line 64
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Update Sort Order")), "html", null, true);
        echo "
\t\t\t\t\t\t</button>
\t\t\t\t\t</li>
\t\t\t\t\t<li>
        ...
        // line 69
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Preview size: ")), "html", null, true);
        echo "
                        \t<a href=\"#gg-big\" class=\"gg-option-links\" data-size-image data-width=\"200\">";
        // line 70
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Big")), "html", null, true);
        echo "</a> / 
                        \t<a href=\"#gg-medium\" class=\"gg-option-links active\" data-size-image data-width=\"150\">";
        // line 71
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Medium")), "html", null, true);
        echo "</a> / 
                        \t<a href=\"#gg-small\" class=\"gg-option-links\" data-size-image data-width=\"80\">";
        // line 72
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Small")), "html", null, true);
        echo "</a>
\t\t                </div>
\t\t\t\t\t</li>
\t\t\t\t\t<li>";
...
\t\t\t\t\t\t\t\t<i class=\"fa fa-fw fa-tags\"></i>";
            // line 79
            echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Show Categories")), "html", null, true);
            echo "
\t\t\t\t\t\t\t</button>
\t\t\t\t\t\t\t<button class=\"button button-primary ggSettingsDisplNone\" data-button=\"hide-categories\">
\t\t\t\t\t\t\t\t<i class=\"fa fa-fw fa-eye-slash\"></i>";
            // line 83
            echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Hide Categories")), "html", null, true);
            echo "
\t\t\t\t\t\t\t</button>";
        }
        // line 86
...
\t        \t\t\t\t\t<a href=\"#gg-rename\" class=\"gg-rename-category\">";
                        // line 148
                        echo Twig_SupTwg_escape_filter($this->env, $context["category"], "html", null, true);
...
\t\t        \t\t\t<label class>";
                    // line 156
                    echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No category")), "html", null, true);
...
\t\t    \t</div>";
   ...
   \t<div id=\"ggRenameCategory\" title=\"";
        // line 165
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Rename Category")), "html", null, true);
        echo "\" style=\"display:none;\">
        <label>";
        // line 166
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("New Name")), "html", null, true);
        echo ": </label>
    ...
    {
        return new Twig_SupTwg_Source("", "@galleries/sort.twig", "/Applications/MAMP/htdocs/wordpress/wp-content/plugins/gallery-by-supsystic/src/GridGallery/Galleries/views/sort.twig");
    }
}
